...
export default function TagsClient({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 gap-x-4">
        {tags &&
          tags
            .sort((a, b) => a.name.localeCompare(b.name))
            .map((tag) => (
              <div key={tag.id} className="cursor-pointer p-4 rounded-md">
